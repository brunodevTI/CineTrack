...
- Nome: Bruno Marinho da Silva
- Matricula: 888925
- Proposta de projeto escolhida: Catálogo de filmes
- Breve descrição sobre seu projeto: O projeto basicamente será um ambiente onde os usuários poderão navegar em busca de filmes na plataforma, houve grandes implementações neste projeto desde a semana 1. O site agora é bem dinâmico, possuindo comandos complexos em sua composição javascript.
